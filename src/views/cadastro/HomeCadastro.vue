<template>
    ...
    <div class="margem container">
        <div class="grid-3">
            <a @click="routerPush('Medicamentos')" style="cursor: pointer" class="card bloco">
                <figure>
                    <img src="@/assets/img/medicamentos.jpg" />
                    <figcaption class="margem abs">Medicamento</figcaption>
                </figure>
            </a>
